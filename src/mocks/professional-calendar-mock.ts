...
export const MOCK_WEEK_SCHEDULE: DaySchedule[] = [
  {
    ...
    slots: [
      ...
      },
      {
        ...
        appointment: {
          id: 'TUR-8802',
          patientName: 'Ramírez Jorge Luis',
          patientDni: '30.112.450',
          specialty: 'Cardiología',
          status: 'confirmed',
        },
      },
      ...
      { time: '10:30', type: 'available' },
      {
        ...
        appointment: {
          id: 'TUR-8803',
          patientName: 'Torres Ana Sofía',
          patientDni: '35.678.901',
      ...
      { time: '11:30', type: 'blocked' },
      {
        ...
        appointment: {
          id: 'TUR-8804',
          patientName: 'Díaz Roberto Ariel',
          patientDni: '22.456.789',
          specialty: 'Cardiología',
          status: 'confirmed',
        },
      },
      { time: '14:30', type: 'available' },
      {
        ...
        appointment: {
          id: 'TUR-8805',
          patientName: 'Flores Valentina',
          patientDni: '40.234.567',
          specialty: 'Cardiología',
          status: 'cancelled',
        },
      },
  ...
  },
  {
    ...
    slots: [
      { time: '09:00', type: 'available' },
      {
        ...
        appointment: {
          id: 'TUR-8810',
          patientName: 'Moreno Pablo Sebastián',
          patientDni: '27.890.123',
          specialty: 'Electrofisiología',
          status: 'confirmed',
        },
      },
      {
        ...
        appointment: {
          id: 'TUR-8811',
          patientName: 'Castro Luciana Beatriz',
      ...
      { time: '11:30', type: 'blocked' },
      {
        ...
        appointment: {
          id: 'TUR-8812',
          patientName: 'Herrera Martín',
          patientDni: '29.345.678',
          specialty: 'Cardiología',
          status: 'pending',
        },
      },
      {
        ...
        appointment: {
          id: 'TUR-8813',
          patientName: 'López Daniela',
          patientDni: '38.901.234',
          specialty: 'Electrofisiología',
          status: 'confirmed',
        },
      },
    ...
    slots: [
      {
        ...
        appointment: {
          id: 'TUR-8820',
          patientName: 'Vega Camila Inés',
          patientDni: '42.123.456',
          specialty: 'Cardiología',
          status: 'confirmed',
        },
      },
    ...
    slots: [
      {
        ...
        appointment: {
          id: 'TUR-8830',
          patientName: 'Peralta Carlos Alberto',
          patientDni: '26.789.012',
          specialty: 'Cardiología',
          status: 'confirmed',
        },
      },
      {
        ...
        appointment: {
          id: 'TUR-8831',
          patientName: 'Ibáñez Rosa María',
          patientDni: '19.345.678',
          specialty: 'Cardiología',
          status: 'confirmed',
        },
      },
      { time: '10:00', type: 'available' },
      {
        ...
        appointment: {
          id: 'TUR-8832',
          patientName: 'Mendoza Rodrigo',
          patientDni: '36.890.123',
          specialty: 'Electrofisiología',
          status: 'pending',
        },
      },
      ...
      { time: '11:30', type: 'blocked' },
      {
        ...
        appointment: {
          id: 'TUR-8833',
          patientName: 'Acosta Paula',
          patientDni: '44.012.345',
          specialty: 'Cardiología',
          status: 'confirmed',
        },
      },
      ...
      { time: '15:00', type: 'available' },
      {
        ...
        appointment: {
          id: 'TUR-8834',
          patientName: 'Ríos Gustavo',
          patientDni: '23.456.789',
          specialty: 'Cardiología',
          status: 'cancelled',
        },
      },
  ...
  },
  {
    ...
    slots: [
      ...
      { time: '09:30', type: 'available' },
      {
        ...
        appointment: {
          id: 'TUR-8840',
          patientName: 'Cabrera Nicolás',
          patientDni: '39.123.456',
          specialty: 'Cardiología',
          status: 'confirmed',
        },
      },
      ...
      { time: '14:30', type: 'blocked' },
      {
        ...
        appointment: {
          id: 'TUR-8841',
          patientName: 'Medina Florencia',
          patientDni: '41.567.890',
          specialty: 'Electrofisiología',
          status: 'confirmed',
        },
      },
