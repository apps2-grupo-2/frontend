          ...
          <CardContent className="p-8">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    id="dni"
                    type="text"
                    className="w-full rounded-lg border border-input bg-background py-3 pr-4 pl-10 text-sm text-foreground transition-colors outline-none focus:border-primary"
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full rounded-lg border border-input bg-background py-3 pr-10 pl-10 text-sm text-foreground transition-colors outline-none focus:border-primary"
                    placeholder="••••••••"
                    value={password}
            ...
            <div className="mt-6 border-t border-border pt-6">
              <p className="text-center text-xs text-muted-foreground">
                ...
                <button className="ml-1 text-accent hover:underline">solicitá acceso online</button>.
              </p>
            </div>
          </CardContent>
        </Card>
